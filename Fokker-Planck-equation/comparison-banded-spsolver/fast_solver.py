...
os.makedirs("results/banded-solver", exist_ok=True)

scheme_name = "banded_solver"
results_filename = f"results/banded-solver/{scheme_name}_{timestamp}.csv"
...
try:
    ...
    for n,Nt in zip(input_seq_n_xv,input_seq_Nt):
        ...
        # Initialization of the ab matrix

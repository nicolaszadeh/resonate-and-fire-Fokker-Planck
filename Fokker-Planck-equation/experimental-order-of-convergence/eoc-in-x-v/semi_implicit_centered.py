...
- Robin treatment at j=0 and j=Nv+1,
- row-wise banded solve in v,
...
os.makedirs("results/semi-implicit-centered", exist_ok=True)

scheme_name = f"semi_implicit_centered_EOC_xv_{restriction_mode}"
results_filename = f"results/semi-implicit-centered/{scheme_name}_{timestamp}.csv"
...
try:
    ...
    def init_xv(n):
        ...
        global p_initial, rho, mass_num_delta
        global i_F, j_0
        global j_neg_x, j_pos_x
        global x_interior_col, v_full_row, J_full
        global ab_row
    ...
    # explicit transport operator B in 2D
    def apply_B_2d(p, N):
        out = p.copy()
        ...
        if i_F > 1:
            ...
            # Robin-type boundary treatment in v

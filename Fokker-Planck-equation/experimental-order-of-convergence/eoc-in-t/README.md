...
The output of the parallel launcher is a log file (especially useful in case of non-completion to understand the source of the error), as well as .csv spreadsheets. 

# -*- coding: utf-8 -*-
"""
Fast explicit centered version:
...
os.makedirs("Results/Explicit_centered", exist_ok=True)

scheme_name = "Current_fast_explicit_centered_time_EOC"
results_filename = f"Results/Explicit_centered/{scheme_name}_{timestamp}.csv"
...
try:
    ...
    def apply_scheme_2d(p, N):
        ...
        - centered x-transport in the interior,
        - centered v-transport in the interior,
        - one-sided/upwind treatment on boundaries,
        - NO critical-strip correction.
        """
        out = p.copy()
        ...
        if i_F > 1:
            ...
            # attenuation everywhere on interior x-rows
            ...
            # Robin-type boundary transport treatment

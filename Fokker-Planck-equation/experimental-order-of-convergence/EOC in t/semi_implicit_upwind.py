# -*- coding: utf-8 -*-
"""
Fast semi-implicit upwind-in-transport version:
...
os.makedirs("Results/Current", exist_ok=True)

scheme_name = "Current_fast_semi_implicit_jc_banded_time_EOC"
results_filename = f"Results/Current/{scheme_name}_{timestamp}.csv"
...
try:
    ...
    # same space grid, so direct comparison
    # ------------------------------------------------------------

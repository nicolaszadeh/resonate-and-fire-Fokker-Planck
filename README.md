...
Selected videos associated with this repository are collected in [YouTube](<https://www.youtube.com/playlist?list=PLiLgCJ1uZsnyLGgZsjczsL3GbCCtGQFVb>) and [PeerTube](https://videos.trom.tf/w/p/iDdfqRZSdQcxfBssikTGwd) playlists.

The playlist includes two-dimensional density animations and three-dimensional
surface visualizations generated by the scripts in this repository.
...
- _comparison-banded-spsolver_: scripts comparing the performance of the vectorized banded solver to the classic spsolve
